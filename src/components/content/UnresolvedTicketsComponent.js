    ...
    render() {
        return (
            <CardComponent containerStyles={this.props.containerStyles} title="Unresolved tickets"
                ...
                items={[
                    this.renderStat('Waiting on Feature Request', 0),
                    this.renderStat('Awaiting Customer Response', 0),
                    this.renderStat('Awaiting Developer Fix', 0),
                    this.renderStat('Pending', 0)
                ]}
            />
        );
    }
